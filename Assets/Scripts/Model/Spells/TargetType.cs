...
namespace Scripts.Model.Spells {
    ...
    public sealed class TargetType {
        ...
        public static TargetType SINGLE_ALLY = new TargetType("One ally", false, (c, p) => p.GetAllies(c).Where(a => a.Stats.State == State.ALIVE).ToArray());
        ...
        public static TargetType SINGLE_ENEMY = new TargetType("One enemy", true, (c, p) => p.GetFoes(c).Where(a => a.Stats.State == State.ALIVE).ToArray());
        ...
        public static TargetType ANY = new TargetType("Any", true, (c, p) => p.GetAll().Where(a => a.Stats.State == State.ALIVE).ToArray());
