...
namespace Scripts.Game.Pages {
    public class Cathedral : VisitablePlace {
        ...
        private void PostSuccess() {
            ...
            GameJolt.API.Scores.Add(flags.DayCount, string.Format("Completed in {0} days at {1} with a level {2} character.", flags.DayCount, flags.Time.GetDescription(), party.Default.Stats.Level), party.Default.Look.Name);
        }
    }
}